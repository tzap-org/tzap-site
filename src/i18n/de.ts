...
export const de = {
  ...
  "zmanager": {
    ...
    "openBoundary": "CLI und Desktop-App nutzen dieselbe ZManager-Engine. Diese Seite ist für Shell-Workflows und Skripting gedacht; die Desktop-Seite bietet native Installer.",
