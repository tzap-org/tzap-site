...
export const ptBR = {
  ...
  "zmanager": {
    ...
    "openBoundary": "A CLI e o aplicativo desktop compartilham o mecanismo ZManager. Use esta página para fluxos de shell e scripts, ou abra a página desktop para instaladores nativos.",
